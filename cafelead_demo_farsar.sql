...
INSERT INTO `careers` (`id`, `unit`, `position`, `etc`, `part_id`) VALUES
(1, 'barname nevis', 'php', 'asdad', 2),
(2, 'GRAPHIC', 'adobe', 'asdad', 3),
(3, 'sales', 'insta', 'asdad', 4),
(4, 'marketing', 'insta', 'asdad', 5);
...
CREATE TABLE `catalog` (
  ...
  `title_fa` varchar(255) COLLATE utf8_persian_ci NOT NULL,
...
INSERT INTO `catalog` (`id`, `url`, `title_fa`, `title_en`) VALUES
(1, '34', 'کاتالوگ نونه اول', 'ttt'),
(2, '34', 'کاتالوگ نونه اول', 'ttt'),
(3, '34', 'کاتالوگ نونه اول', 'ttt'),
(4, '34', 'کاتالوگ نونه اول', 'ttt'),
(5, '34', 'کاتالوگ نونه اول', 'ttt'),
(6, '34', 'کاتالوگ نونه اول', 'ttt'),
(7, '34', 'کاتالوگ نونه اول', 'ttt'),
(8, '34', 'کاتالوگ نونه اول', 'ttt'),
(9, '34', 'کاتالوگ نونه اول', 'ttt'),
(10, '34', 'کاتالوگ نونه اول', 'ttt');
...
INSERT INTO `contacts` (`id`, `map_location`, `etc`, `tel`, `social_media`, `email`) VALUES
(1, 'a', 'UNIT 144,FL 14, <span>SADAF TOWER</span>, SHEIKHBAHAEE SQ, TEHRAN, IRAN<br/>\r\n+98 <span>21</span> 8821 1110<br/>\r\nINFO@<span>LUXTAI</span>.COM', '111111,222222,33333', NULL, '');
...
(1, 'Blog', 'Blog', 'dev', 'blog', 1, '2019-02-27 06:35:45', '2019-02-27 06:35:45'),
(2, 'Card', 'Card', 'dev', 'card', 1, '2019-02-27 06:36:05', '2019-02-27 06:36:05'),
(3, 'Faq', 'Faq', 'dev', 'faq', 1, '2019-02-27 06:36:59', '2019-02-27 06:36:59'),
(4, 'News', 'News', 'dev', 'news', 1, '2019-02-27 06:40:40', '2019-02-27 06:40:40'),
(5, 'Product', 'Product', 'dev', 'product', 1, '2019-02-27 06:40:47', '2019-02-27 06:40:47'),
(6, 'Project', 'Project', 'dev', 'project', 1, '2019-02-27 06:40:55', '2019-02-27 06:40:55');
...
INSERT INTO `news` (`id`, `title`, `body`, `slug`, `imageUrl`, `lang`, `active`, `created_at`, `updated_at`) VALUES
(1, 'اخبار 1', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد. \r\nلورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد. ', 'test-1', '/images/NewsFA7.jpg', 'fa', 1, NULL, NULL),
