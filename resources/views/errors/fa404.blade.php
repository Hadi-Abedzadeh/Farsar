...
<!DOCTYPE html>
<html dir="rtl" class="no-js" lang="fa-IR"><head>
    <meta charset="UTF-8">
    ...
    <title> | فرسام </title>
    <link rel="stylesheet" href="/farsar/assets/css/stylesheet.css">
    <!--[if lt IE 10]>
...
<div class="wrapper" id="main-page">
    <header class="site-header site-header-main site-header-main-single" id="sectionup">
        <figure class="bg-img-header bg-gr-header">
            <img src="/farsar/assets/images/sample/bg-header1.png" alt="" title="">
        </figure>
        <div class="container">
                ...
                <article class="art-header-right">
                    <figure>
                        <a href="javascript:void(0)" title="farsar">
                            <img src="/farsar/assets/images/sample/logo.png" alt="farsar" title="farsar">
                        </a>
                    </figure>
    ...
    <li><a href="http://127.0.0.1:8000/contact-us" title="تماس با ما">تماس با ما</a></li>
        ...
        <figure class="bg-img-header-bottom bg-img-header-single">
            <img src="/farsar/assets/images/sample/header.svg" alt="" title="">
        </figure>
    </header>
    <div class="search-header"><form action="#"><i class="i-s icon-Search"></i><input type="search" placeholder="عبارت مورد نظر خود را وارد کنید … "></form><span class="close-search"><img src="/farsar/assets/images/sample/close-search.svg" alt="" title=""></span></div>
    ...
    <footer class="site-footer footer-index" role="contentinfo">
        ...
        <figure class="bg-img-footer-top">
            <img src="/farsar/assets/images/sample/footer-path.svg" alt="" title="">
        </figure>

    </footer>
</div>

<script src="/farsar/assets/js/jquery-3.3.1.min.js"></script>
<script src="/farsar/assets/js/swiper.jquery.min.js" defer="defer"></script>
<script src="/farsar/assets/js/parallax.min.js" defer="defer"></script>
<script src="/farsar/assets/js/script.js" defer="defer"></script>
