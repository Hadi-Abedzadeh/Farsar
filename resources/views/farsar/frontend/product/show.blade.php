                    ...
                    <div class="col-md-13">
                        <article class="art-content-any-products">
                            <header>
                                ...
                                <strong class="bg-fa">
                                    <span class="c-h2"> CODE <em class="f-c-b">{{ $product_list->code }}</em></span>
                                </strong>
                            </header>
                            <p class="c-p">
                                {!! $product_list->body !!}
                            ...
                            <a class="a-btn-bggr a-btn a-btn-bigger" href="javascript:void(0)"
                               title="دانلود کاتالوگ محصول">دانلود
                                کاتالوگ محصول</a>
                        </article>
                    </div>
                </div>
                        ...
                        @foreach($same_products as $same_product)
                            ...
                            <div class="swiper-slide">
                                <article class="art-content-sider art-content-sider-any">
                                    <div>
                                        <figure>
                                            <img src="{{ json_decode($same_product->imageUrls)->img1 }}"
                                                 alt="{{ $same_product->title }}" title="{{ $same_product->title }}">
                                        </figure>
                                    </div>
                                    <header>
                                    ...
                                    <a class="a-btn-bggr a-btn"
                                       href="{{ route('frontend.product.show', ['slug' => $same_product->slug, 'lang' => 'fa']) }}"
                                       title="مشاهده محصول">مشاهده
                                        محصول</a>
                                </article>
                            </div>
                        @endforeach
